...
?>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Effacer un véhicule</h1>
          <p class="mb-4">Veuillez selectionner le Vehicule pour l'effacer</a>.</p>

          <!-- DataTales Example -->
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Effacer un véhicule</h6>
            </div>
            <div class="card-body">
            <form  method="POST">
            <select class="browser-default custom-select" name="id">
            <option selected>Selectionner un véhicule pour l'effacer</option>
            <?php
use Site\Vehicule;
