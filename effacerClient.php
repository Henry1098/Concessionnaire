...
?>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Effacer un client</h1>
          <p class="mb-4">Veuillez selectionner un client pour l'effacer</a>.</p>

          <!-- DataTales Example -->
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Effacer client</h6>
            </div>
            <div class="card-body">
            <form  method="POST">
